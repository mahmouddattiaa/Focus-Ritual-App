          ...
          >
            ...
            <Button
              ...
              onClick={async () => {
                ...
                setEmail("guest@focusritual.com");
                setPassword("demo123");
                
                try {
                  await login({ email: "guest@focusritual.com", password: "demo123" });
                  navigate('/dashboard');
                } catch (err) {
                  // Error handled by useAuth hook
                }
              }}
              className="w-full mt-3 bg-gradient-to-r from-emerald-500 to-teal-600 text-white font-semibold py-2 rounded-lg shadow-lg hover:from-emerald-600 hover:to-teal-700 transition-all duration-300 transform hover:scale-105"
              disabled={loading}
            >
              Try Demo Account
              <ArrowRight className="ml-2 w-4 h-4" />
